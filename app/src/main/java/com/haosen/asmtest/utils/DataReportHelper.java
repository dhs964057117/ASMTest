...
public class DataReportHelper {
    ...
    public static void onCheckedChanged(CompoundButton view, boolean isChecked) {
        System.out.println("自动埋点 --> ViewId:" + getViewId(view) + " ViewText:" + getElementContent(view) + " isChecked:" + isChecked);
    }

    @Keep
    public static void onCheckedChanged(CompoundButton view) {
        System.out.println("自动埋点 --> ViewId:" + getViewId(view) + " ViewText:" + getElementContent(view) + " isChecked:" + view.isChecked());
    }
